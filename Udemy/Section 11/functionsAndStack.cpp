// Section 11 - How Function Calls Work in Memory.
...
/*	
	...
	main:
		push space from the return value
		push space for the parameters
		push the return address
		tranfer control to func1 (jmp)
	...
	func1:
		...
		resotre the previous activiation record (move the stack pointer)
